...
public class JTableWith2RowHighliting extends JTable {
  ...
  public Component prepareRenderer(TableCellRenderer renderer, int row, int column) {
    ...
    if (row % 2 == 1) {
      ...
      Color bkgNew = new Color(Math.max((int) (bkg.getRed() - 25), 0), Math.max((int) (bkg.getGreen() - 25), 0), Math.max((int) (bkg.getBlue() - 25), 0));
