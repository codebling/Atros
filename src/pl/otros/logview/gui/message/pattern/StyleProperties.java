...
public class StyleProperties {
  ...
  public static Style getStyle(StyledDocument styledDocument, DataConfiguration styleConfig, String styleName) {
    return getStyle(styledDocument, styleConfig, styleName, -1);
  }

  public static Style getStyle(StyledDocument styledDocument, DataConfiguration styleConfig, String styleName, int group) {
    Style style = styledDocument.addStyle(styleName, styledDocument.getStyle(StyleContext.DEFAULT_STYLE));
